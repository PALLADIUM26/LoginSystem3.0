...
public class About extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("LinkedIn Profile");

        jButton3.setText("Twitter Profile");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("CSE Junior @SNU\nAI/ML dev\nBackend dev @Shiftux\nCompetitive coder");
        jScrollPane1.setViewportView(jTextArea1);

        jTextArea2.setColumns(20);
        jTextArea2.setRows(5);
        jTextArea2.setText("TECH STACK:\n- Java\n- Python\n- MySQL\n");
        jScrollPane2.setViewportView(jTextArea2);

        jLabel2.setText("Projects at:");

        jLabel3.setText("Socials:");

        jButton4.setText("Instagram Profile");
        ...
        jLabel5.setText("Mail me: pranithdutta26@gmail.com");
    ...
    private void btnGitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGitActionPerformed
        try {
            URI u = new URI("https://github.com/PALLADIUM26");
